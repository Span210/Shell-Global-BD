...
echo ************************************************************************************************************************************
echo *codigo creado por: Aimeé Rogelia Navarrete López
echo *Descripción: Este codigo te permite interactuar con una base de datos Postgres y obtener información sobre su estado, 
